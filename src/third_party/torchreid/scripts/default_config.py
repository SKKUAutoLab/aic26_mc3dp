...
def get_default_config():
    ...
    cfg.model.save_model_flag = '/home/vsw4/pita/aicity25/keypoint_promptable_reidentification/logs/aicity25'  # path to checkpoint for resume training
    ...
    cfg.data = CN()
    cfg.data.type = "image"
    cfg.data.root = "/media/vsw4/4AB2757CB2756D774/aicity25_dataset/MTMC_Tracking_2025/"
    ...
    cfg.train.max_epoch = 120 # default 120
    cfg.train.start_epoch = 0
    cfg.train.batch_size = 256 # 64 default
    ...
    cfg.train.stepsize = [40, 70]  # stepsize to decay learning rate # [40, 70]
